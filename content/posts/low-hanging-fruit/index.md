...
{{< figure src="image2.png" caption="Global GDP for the last 2000 years (Our World in Data)" width="600">}}

If we measure development through GDP over the last 2000 years, innovation is clearly speeding up instead of stagnating or slowing down.[^GDP] 
...
{{< figure src="image1-text2.png" caption="Log plot of global GDP for the last 2000 years ([www.cold-takes.com/most-important-century](https://www.cold-takes.com/most-important-century/))" width="700">}}
...
- Then on the business side, the most useful advice I've heard so far is that you have to realise [you can't build technology around people, you have to build for people.](https://www.youtube.com/watch?v=1b2LfAGkkpk) At the end of the day it's humans who have to find utility in what you create.
...
[^GDP]: Note there are many ways of measuring the development of society. Another would be the ability of people to produce energy. One thing that might link physical/digital innovation is the idea that information is a form of energy. See Sapiens 
by Yuval Noah Harari or [Ian Morris' works](https://80000hours.org/podcast/episodes/ian-morris-big-picture-history/) for more.Additionally, population increase over the last centuries is also a confounding factor for GDP.

[^course]: Although I would argue that that we might have less agency to change the course of history than this phrasing suggests. More accuartely, I would say history evolves along the incentives at that time. [See here for more.](https://80000hours.org/podcast/episodes/ian-morris-big-picture-history/)

[^inspiration]: This article was inspired by Peter Thiel's Zero to One by, which helped shape several ideas here

[^productivity]: I think a more exact framing would be to tie innovation impact to increases in economic productivity



<!-- To be able to understand the future of innovation, we must first understand the past. -->
