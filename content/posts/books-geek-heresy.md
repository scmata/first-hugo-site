+++ 
draft = true
date = 2025-08-04T10:45:27+08:00
title = ""
description = ""
slug = ""
authors = []
...
# A summary of geek heresy


Geek heresy was one of the most impactful books in the last year and it did a lot to reframe some of my models of impact and success. Here are my key takeaways:


Technology is not a silver bullet, even though we think it is:

Some facts:
Poverty decreased steadily in the US until 1970, where it has held steady until 2007, where it increased. Inequality has increased
- Several new technologies have been introduced since 1970. Such as the internet (Apple, GOogle, Microsoft) and the personal computer. But life for people hasn't improved. Why?
